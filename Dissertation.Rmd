...
OptimalLag1 <- VARselect(clean_data1[,-c(1,2)], lag.max = 5, type = "both")$selection
OptimalLag2 <- VARselect(clean_data2[,-c(1,2)], lag.max = 5, type = "both")$selection
