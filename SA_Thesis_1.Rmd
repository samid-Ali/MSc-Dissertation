...
Our review of the literature has highlighted 2 notable gaps. Firstly, the lack of research investigating fiscal multipliers in the UK. While it could be argued that results from other developed economies could be extrapolated to the UK, we have highlighted that structural characteristics in economies can lead to meaningful differences in the estimated multipliers. Having highlighted the costs of indebtedness, the need for fiscal consolidation, and the risk of using incorrect fiscal multipliers, this motivates the first objective of this research: to estimate the fiscal multipliers in the UK. As a second objective, we aim to provide a review of the assumptions often made implicit in SVAR analysis. The motivation for this is to highlight the modelling decisions made and how our results may be sensitive to these. Given the emphasis placed on specification differences affecting estimates of the multiplier, this is a crucial gap in the research.  
...
```{r IRF-comp-Expenditure, fig.cap="GDP Responses to Government Spending Compared", fig.align='center'}
...
```{r IRF-comp-Expenditure_all, fig.cap="GDP Responses to Government Expenditure Compared 2", fig.align='center'}
# Plot Expenditure IRFs
