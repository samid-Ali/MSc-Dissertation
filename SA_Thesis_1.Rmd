...
Table 1 summarises the multipliers reported by this paper. Overall governement spending multipliers suggest a crowding out effect. This response is both weak and statistically insignificant. In contrast, we found a statistically significant and positive multiplier for government revenue. These results were robust to our robustness checks, despite some evidence of the the government revenue multiplier being larger following the GFC. 
