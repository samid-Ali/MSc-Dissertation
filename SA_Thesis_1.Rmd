...
They use duration analysis to support their analysis, investigating **how** 
...
## Synthesis of Methodology and Review of Estimates
...
Identification is based on economic theory, which we have justified. Additionally, alternative identificatying assumptions are associated with ... therefore we would expect different multipliers. Instead the purpose of this section is to test for the robustness of the reduced form.
...
The objective of this paper has been to estimate baseline fiscal multipliers for the UK twofold motivation, quantify to guide UK fiscal consolidation plans, 2) address methodological concerns highlighted.
...
percentiles <- quantile(exp_change_df$expenditure_change, probs = c(0.75, 0.95), na.rm = TRUE)
percentile_df <- data.frame(
  percentile = c("75th percentile", "95th percentile"),
